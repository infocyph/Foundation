...
- [ ] Verify every planned OAuth audit event is emitted at the correct lifecycle boundary: authorization denial, code consume/expire/replay, refresh rotate/revoke/reuse, authorization revoke, invalid redirect/scope, rate-limit rejection, and signing-key readiness/selection failure.
